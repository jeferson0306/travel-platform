package com.travelplatform.payment.architecture;
...
class HexagonalArchitectureTest {
    ...
    private static final JavaClasses CLASSES =
            new ClassFileImporter()
                    ...
                    .importPackages("com.travelplatform.payment");
    ...
    void layersOnlyDependInward() {
        layeredArchitecture()
                ...
                .layer("Domain")
                .definedBy("com.travelplatform.payment.domain..")
                .layer("Application")
                .definedBy("com.travelplatform.payment.application..")
                .layer("Infrastructure")
                .definedBy("com.travelplatform.payment.infrastructure..")
                .layer("Api")
                .definedBy("com.travelplatform.payment.api..")
                .whereLayer("Domain")
    ...
    void domainNeverDependsOnFrameworkTypes() {
        noClasses()
                .that()
                .resideInAPackage("com.travelplatform.payment.domain..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
