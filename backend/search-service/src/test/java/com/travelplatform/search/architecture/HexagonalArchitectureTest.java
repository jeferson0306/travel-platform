package com.travelplatform.search.architecture;
...
class HexagonalArchitectureTest {
    ...
    private static final JavaClasses CLASSES =
            new ClassFileImporter()
                    ...
                    .importPackages("com.travelplatform.search");
    ...
    void layersOnlyDependInward() {
        layeredArchitecture()
                ...
                .layer("Domain")
                .definedBy("com.travelplatform.search.domain..")
                .layer("Application")
                .definedBy("com.travelplatform.search.application..")
                .layer("Infrastructure")
                .definedBy("com.travelplatform.search.infrastructure..")
                .layer("Api")
                .definedBy("com.travelplatform.search.api..")
                .whereLayer("Domain")
    ...
    void domainNeverDependsOnFrameworkTypes() {
        noClasses()
                .that()
                .resideInAPackage("com.travelplatform.search.domain..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
                        "io.quarkus..", "jakarta..", "org.opensearch..", "io.smallrye..")
                .check(CLASSES);
    }
}
