package com.travelplatform.hotel.architecture;
...
class HexagonalArchitectureTest {
    ...
    private static final JavaClasses CLASSES =
            new ClassFileImporter()
                    ...
                    .importPackages("com.travelplatform.hotel");
    ...
    void layersOnlyDependInward() {
        layeredArchitecture()
                ...
                .layer("Domain")
                .definedBy("com.travelplatform.hotel.domain..")
                .layer("Application")
                .definedBy("com.travelplatform.hotel.application..")
                .layer("Infrastructure")
                .definedBy("com.travelplatform.hotel.infrastructure..")
                .layer("Api")
                .definedBy("com.travelplatform.hotel.api..")
                .whereLayer("Domain")
    ...
    void domainNeverDependsOnFrameworkTypes() {
        noClasses()
                .that()
                .resideInAPackage("com.travelplatform.hotel.domain..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
