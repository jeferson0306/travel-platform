package com.travelplatform.identity.architecture;
...
class HexagonalArchitectureTest {
    ...
    private static final JavaClasses CLASSES =
            new ClassFileImporter()
                    ...
                    .importPackages("com.travelplatform.identity");
    ...
    void layersOnlyDependInward() {
        layeredArchitecture()
                ...
                .layer("Domain")
                .definedBy("com.travelplatform.identity.domain..")
                .layer("Application")
                .definedBy("com.travelplatform.identity.application..")
                .layer("Infrastructure")
                .definedBy("com.travelplatform.identity.infrastructure..")
                .layer("Api")
                .definedBy("com.travelplatform.identity.api..")
                .whereLayer("Domain")
    ...
    void domainNeverDependsOnFrameworkTypes() {
        noClasses()
                .that()
                .resideInAPackage("com.travelplatform.identity.domain..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
