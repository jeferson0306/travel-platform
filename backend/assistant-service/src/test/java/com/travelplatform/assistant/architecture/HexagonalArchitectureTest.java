package com.travelplatform.assistant.architecture;
...
class HexagonalArchitectureTest {
    ...
    private static final JavaClasses CLASSES =
            new ClassFileImporter()
                    ...
                    .importPackages("com.travelplatform.assistant");
    ...
    void layersOnlyDependInward() {
        layeredArchitecture()
                ...
                .layer("Domain")
                .definedBy("com.travelplatform.assistant.domain..")
                .layer("Application")
                .definedBy("com.travelplatform.assistant.application..")
                .layer("Infrastructure")
                .definedBy("com.travelplatform.assistant.infrastructure..")
                .layer("Api")
                .definedBy("com.travelplatform.assistant.api..")
                .whereLayer("Domain")
    ...
    void domainNeverDependsOnFrameworkTypes() {
        noClasses()
                .that()
                .resideInAPackage("com.travelplatform.assistant.domain..")
                .should()
                .dependOnClassesThat()
                .resideInAnyPackage(
